...
Selama mengikuti praktikum Data Science dari Pertemuan 1 hingga Pertemuan 7, saya belajar tahap-tahap dasar dalam mengolah data: mengumpulkan data, membersihkan data, menganalisis, dan membuat visualisasi.

Saya juga mulai mengenal Machine Learning lewat model regresi linear dan cara menilai hasil model. Dari semua praktikum ini, saya jadi lebih paham bagaimana data bisa diolah menjadi informasi untuk mendukung pengambilan keputusan berbasis data.
